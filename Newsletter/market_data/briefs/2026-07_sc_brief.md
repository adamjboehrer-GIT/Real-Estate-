...
- **Petrol Club — USED as the "What's New in San Clemente" (lifestyle) section, heading "Another Coffee Shop? Not Quite":** third-wave coffee shop + rotating collectible-car display at **824 N. El Camino Real**, San Clemente. Founders Bobby Guedea and Nick Ferrara (South County locals). Cars in-room, no ropes (Ford GT, Porsche 996, BMW); kids' sandbox/play space out back; sells merch. Open as of June 2026. Opens with a self-deprecating "just what SC needed, another coffee shop" joke, then pivots to the car-enthusiast niche it serves, incl. the local Cars and Coffee crowd that meets at the outlets (per Adam's local knowledge — NOT web-verified, confirm before send). Moved here from the neighborhood section at Adam's direction; the concert-series item was retired to make room. (Picket Fence Media, Yelp, Instagram @the.petrol.club)
- **Summer Concert Series — retired for this issue (available alternate):** free Thursday concerts 6pm at the Pier / Linda Lane Park, ~Jul 9–Aug 13, 2026; Fiesta Music Festival Aug 8. Neighborhood section is now a single price-focused item ("Let's Talk Price").
- **Miramar Food Hall (North Beach) — available alternate:** historic 1938 theater / old bowling alley reopened **June 18, 2026** at 1720 N. El Camino Real: ~12,600 sq ft, 15 food vendors + 2 full bars; Wedgewood restoration, Tiger Hospitality operator.
