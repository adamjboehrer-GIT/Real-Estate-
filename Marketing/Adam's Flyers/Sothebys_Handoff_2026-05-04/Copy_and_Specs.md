...
> **Revision 2026-05-08 (later same day)** — Display serif swapped from Cormorant Garamond to **Newsreader** (Production Type, Google Fonts), and display-name + headline weights bumped to semibold (600 — brand max). Cormorant Garamond's delicate strokes were reading as thin/weak at print size; Newsreader's editorial weight is much closer to Mercury / Freight in feel. Final art should still substitute the licensed brand fonts (Freight or Mercury) — Newsreader is the closest free fallback for the mockup.
>
