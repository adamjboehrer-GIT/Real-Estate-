...
- **Body (italic serif, 17.5 pt):** Most coastal sales don't start on Zillow. A buyer comes to me with an idea of what they want, and my job is to find the right home, often from an owner I've already talked with.
- **CTA line (sans):** So if you're thinking about selling in the next year or two, let's talk well before you list.
