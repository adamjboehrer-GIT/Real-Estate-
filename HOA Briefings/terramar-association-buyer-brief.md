...
If the home isn't on one of those streets, there is no path to a key.

## What it costs

| Item | Amount |
|---|---|
| New owner initiation fee (one-time) | $650 |
| Annual dues per key | $150 |
| Maximum keys per legal lot | 2 |
| Replacement key (limit 1/year) | $150 |
| Late renewal fee (after June 30) | $25 |
| Tenant add-on (if renting out) | $150/yr on top of owner's $150 |
